...
- Special Transit Zones operational in pilot regions
...
## Existing Neighborhood Treatment Files (Subdomain Detail)

| File | Focus | Phase | Status |
|------|-------|-------|--------|
| neighborhood-civic-overlay.md | Opt-in zoning for walkable amenities | 3 | Active |
| neighborhood-infrastructure-solvency-test.md | LIFT fiscal test for new development | 3 | Active |
| transit-escalation-and-stz-interface.md | Transit escalation triggers, STZ integration | 3 | Active |
| national-seam-infrastructure-and-coordinated-development-plan.md | Coordinated neighborhood pilots | 2 | Active |
| state-and-federal-incentive-alignment.md | Conditional capital, performance-based funding | 2 | Active |
...
|---------------------|-------------|--------|------------|
| Capital allocation framework | Budget | Phase 2 | High |
| STZ enabling legislation | Democratic_Integrity | Phase 2 | Medium |

### Soft Dependencies (Coordination)
| This Domain Benefits From | From Domain | Status | Notes |
|--------------------------|-------------|--------|-------|
| Digital infrastructure | Technology_and_Data | Phase 2 | Smart infrastructure |
| Healthcare access networks | Healthcare | Phase 3 | Seam district integration |
| Agricultural distribution | Economic_Prosperity | Phase 3 | Food access corridors |
...
- [x] **Core Infrastructure Vision** – Spine, STZ, modularity complete ✅
...
- [ ] **Ports and logistics** – Freight infrastructure – Target: Phase 3
...
- [x] Infrastructure spine architecture defined
- [x] STZ framework with escalation triggers
