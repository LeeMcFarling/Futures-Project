...
```mermaid
timeline
  title IDP social layer rollout
  section Foundation
    Charter + reciprocity rules + ethics compact : 2026 H1
    Privacy + measurement protocol (opt-in, aggregation, DP) : 2026 H1
    Accreditation of schools/VET/employers/sponsors : 2026 H2
  section Pilot
    Youth 18–30 cohorts + VET/apprenticeships pilots : 2027 H1
    Sector rotations (eng/log/health/cyber) + exercises : 2027 H2
    Baseline FDI + congestion monitoring : 2027 H2
  section Scale
    Trigger-based quota expansion + destination routing : 2028
    Annual public reporting + independent evaluation : 2028+
```
